...
Follow the [Upstash Box quickstart](https://upstash.com/docs/box/overall/quickstart) to create an API key and a Box, then add:
...
QStash environment variables are not required for this chat flow.
